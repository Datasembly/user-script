...
(function() {
    ...
    if (/https:\/\/www.walmart.com\/ip\/.*/.test(window.location.href)) {
        ...
        if (script) {
            ...
            var url = "https://ec2-54-210-20-248.compute-1.amazonaws.com:3000/dashboard?banner=c624d14d-b312-4e13-a8cf-080171cb50f3&upc=" + upc;
        ...
        let url = "https://ec2-54-210-20-248.compute-1.amazonaws.com:3000/dashboard?banner=c475577f-1d89-47ab-b271-f7e90dae4eb4&upc=" + upc;
       ...
       let url = "https://ec2-54-210-20-248.compute-1.amazonaws.com:3000/dashboard?banner=ed156cf2-cc4d-4017-868f-dd1dc76914e3&upc=" + upc;
       ...
       let checkAndAdd = function() {
           ...
           let url = "https://ec2-54-210-20-248.compute-1.amazonaws.com:3000/dashboard?banner=937be4a1-875c-4489-993f-b60ae9268c1a&upc=" + upc;
       ...
       $(window).on('hashchange', function(e){
         ...
         let url = "https://ec2-54-210-20-248.compute-1.amazonaws.com:3000/dashboard?banner=218ca758-17de-49c4-932e-61486fe6c46d&upc=" + upc;
